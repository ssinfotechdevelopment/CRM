...
const EmployeeAttendance = () => {
    ...
    async (isRefresh = false) => {
      ...
      try {
        ...
        const [attendanceRes, holidaysRes] = await Promise.all([
          fetch("https://crm-backned-v1.onrender.com/api/attendance/history", {
            headers: { Authorization: `Bearer ${token}` },
          }),
          fetch("https://crm-backned-v1.onrender.com/api/holidays/all"),
        ]);
  ...
  const handleClockIn = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "https://crm-backned-v1.onrender.com/api/attendance/clock-in",
        {
          method: "POST",
          headers: {
  ...
  const handleClockOut = async () => {
    ...
    try {
      const res = await fetch(
        "https://crm-backned-v1.onrender.com/api/attendance/clock-out",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
