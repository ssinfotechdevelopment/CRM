...
const EmployeeAttendance = () => {
  ...
  const fetchAttendance = useCallback(async () => {
    ...
    try {
      const res = await fetch(
        "https://crm-backned.onrender.com/api/attendance/history",
  ...
  const handleClockIn = async () => {
    ...
    try {
      ...
      const res = await fetch(
        "https://crm-backned.onrender.com/api/attendance/clock-in",
        {
          method: "POST",
          headers: {
  ...
  const handleClockOut = async () => {
    ...
    try {
      const res = await fetch(
        "https://crm-backned.onrender.com/api/attendance/clock-out",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
