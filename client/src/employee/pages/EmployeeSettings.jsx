...
const EmployeeSettings = () => {
  ...
  const fetchEmployeeData = async () => {
    try {
      setLoading(true);
      const res = await fetch("http://sscrmbackend.ssinfotech.co.in/api/employee/me", {
        headers: {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://sscrmbackend.ssinfotech.co.in/api/employee/me/change-password", {
        method: "PATCH",
        headers: {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://sscrmbackend.ssinfotech.co.in/api/employee/me/update-profile", {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`
